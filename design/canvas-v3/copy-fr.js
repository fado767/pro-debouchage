...
module.exports = {
  ...
  under: `Avec une photo, on comprend le problème tout de suite, et on vous aide plus vite.`,
  ...
  trust: [
    '24h/24, 7j/7, fériés compris',
    'Prix dit au téléphone',
    'Confirmé à votre porte',
    'Caméra comprise',
    'Entreprise 1027.454.187',
  ...
  priceBtn: 'Appeler',
  guarH: 'Garantie retour 30 jours',
  guarP: `Si la même canalisation se rebouche dans les 30 jours, on revient gratuitement. Cette garantie s'ajoute à vos droits légaux, elle ne les remplace pas.`,
  guarRing: 'GARANTIE',
  promise: 'Le prix annoncé au téléphone est le prix sur la facture.',

  // Before / after slider.
  baK: 'Avant, après', baH: `Le bouchon part. La preuve reste.`,
  baIntro: `Glissez le trait pour comparer.`,
  baBefore: 'AVANT', baAfter: 'APRÈS',
  baAlt: { before: 'WC bouché, la cuvette pleine d’eau sale, avant l’intervention.', after: 'Le même WC, propre et débouché, après l’intervention.' },
  baCaption: `Illustration fidèle, créée à partir de la photo de notre propre intervention (WC bouché, 2026). La photo d'origine, avec notre technicien, est dans la galerie ci-dessous.`,
  baAria: 'Comparer avant et après',

  // Scam band + our checklist, point by point.
  scamK: 'Bon à savoir', scamH: `Comment reconnaître une arnaque au débouchage`,
  scamI: `La région de Hal-Vilvorde est tristement connue pour ça${nb}: plus de 265 victimes entre 2020 et 2025, et un procès en 2025. Quatre signes qui doivent vous faire raccrocher${nb}:`,
  scam: [
