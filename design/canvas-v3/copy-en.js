...
module.exports = {
  ...
  waBtn: 'Send a photo',
  under: 'A photo shows us the problem straight away, so we can help you faster. And you can call in English, day or night.',
  ...
  trust: [
    ...
    'Confirmed at your door',
    'Camera included',
    'Company no. 1027.454.187',
    'Insured with AG Insurance',
    '30-day comeback guarantee'],
  ...
  priceBtn: 'Call',
  guarH: '30-day comeback guarantee',
  guarP: "If the same pipe blocks again within 30 days, we come back for free. This guarantee is on top of your legal rights, it doesn't replace them.",
  guarRing: 'GUARANTEE',
  promise: 'The price you hear on the phone is the price on the invoice.',

  baK: 'Before and after', baH: 'The blockage goes. The proof stays.',
  baIntro: 'Drag the line to compare.',
  baBefore: 'BEFORE', baAfter: 'AFTER',
  baAlt: { before: 'Blocked toilet, the bowl full of dirty water, before the job.', after: 'The same toilet, clean and unblocked, after the job.' },
  baCaption: "A faithful illustration, created from the photo of our own job (blocked toilet, 2026). The original photo, with our technician, is in the gallery below.",
  baAria: 'Compare before and after',

  scamK: 'Worth knowing', scamH: 'How to spot a drain-unblocking scam',
  scamI: 'The Halle-Vilvoorde area is sadly known for this: over 265 victims between 2020 and 2025, and a court case in 2025. Four signs that should make you hang up:',
  scam: [
