// Builds the v3 site into ../../site-v3/ from template.js (markup), copy-fr/nl/en.js (copy),
// styles.css (design, INLINED into every <head>), cgv.js (general terms), the v2 legal.js
// (privacy pages, reused with the enterprise-number prefix fix) and assets/prepared/web/ (images).
// Run: node design/canvas-v3/build.js     Output is generated: never edit site-v3/ by hand.
// ADS_TAG_ID=AW-... builds the consent + Google-tag layer exactly like v2 (see canvas-v2/README.md).
...
const LEGAL_V2 = require('../canvas-v2/legal.js');
const fixBce = s => s
...
if (ADS_TAG_ID) {
  ...
  w('assets/js/consent.js', `// Generated by design/canvas-v3/build.js. Do not edit here.
(function(){
...
const IMGS = {
  ...
  'ba-before.webp':  { base: 'ba-before', widths: [480, 800], w: 800, h: 1000, sizes: '(min-width: 900px) 460px, 92vw' },
  'ba-after.webp':   { base: 'ba-after', widths: [480, 800], w: 800, h: 1000, sizes: '(min-width: 900px) 460px, 92vw' },
};
for (const k in IMGS) {
  const m = IMGS[k];
...
function head(lang, paths, m, opts = {}) {
  ...
  return `<!DOCTYPE html>
<!-- Generated by design/canvas-v3/build.js. Do not edit by hand: edit the sources in design/canvas-v3/ and rebuild. -->
