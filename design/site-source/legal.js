...
const COOKIES_TAG = {
  fr: `    <h2>Cookies et mesure</h2>
    <p>Ce site utilise un seul outil tiers&nbsp;: la mesure de Google (Google Ireland Ltd), qui nous dit si nos annonces Google amènent des appels et comment nos pages sont utilisées. Rien n'est chargé avant votre choix&nbsp;: une bannière propose "Tout refuser" et "Tout accepter", aussi visibles et aussi simples l'un que l'autre. Si vous acceptez, Google peut déposer des cookies (préfixes _gcl et _ga) sur votre appareil. Votre choix est gardé sur votre appareil, six mois au maximum, puis la question vous est reposée. Vous pouvez changer d'avis à tout moment via le lien "Cookies et mesure" en bas de chaque page&nbsp;; refuser efface ces cookies.</p>
  ...
  en: `    <h2>Cookies and measurement</h2>
    <p>This site uses one third-party tool: Google's measurement (Google Ireland Ltd), which tells us whether our Google ads bring in calls and how our pages get used. Nothing loads before you choose: a banner offers "Refuse all" and "Accept all", equally visible and equally simple. If you accept, Google may set cookies (prefixes _gcl and _ga) on your device. Your choice stays on your device for six months at most, then we ask again. You can change your mind at any time via the "Cookies and measurement" link at the bottom of every page; refusing deletes those cookies.</p>
