...
1. A payment method (one card across unrelated Ads accounts is a relatedness signal and a related-accounts suspension is close to unappealable). Roro pays his Ads on his own business card since the swap of 2026-08-28, and the Workspace card is his own Mastercard 2616 too (owner: `accounts.md`, Workspace row, read 2026-09-02); only the domain invoices were fronted by Fady and they settle at handover; the agency card is at most a build instrument with a removal date, and for Ads not even that.
